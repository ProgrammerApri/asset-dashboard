...
const Produk = ({ edit, del }) => {
  ...
  const [gprod, setGprod] = useState(null);
    ...
    try {
      ...
      if (response.status) {
        ...
        data?.forEach((element) => {
          filt?.push(element.group);
        });

        let groupprd = filt?.filter(
          (el, i) => i === filt.findIndex((ek) => el?.id === ek?.id)
        );
          ...
          <Card>
            <Card.Body className="p-0">
              <Row>
                ...
                <div className="col-8 mt-4">
                  <h4 className="fs-18 text-black font-w600 mb-0">
                    <b>{product?.length} Item Produk</b>
                  </h4>
                ...
                <Card>
                  <Card.Body className="p-0">
                    <Row>
                      ...
                      <div className="col-8 mt-4">
                        <h4 className="fs-12 text-black font-w600 mb-0">
                           Grup Produk <b>{v?.name}</b>
                        </h4>
