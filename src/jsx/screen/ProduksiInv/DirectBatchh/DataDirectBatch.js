...
const DataDirectBatch = ({ onAdd, onEdit, onDetail }) => {
        ...
        <Link
          onClick={() => {
            ...
            dispatch({
              ...
              payload: {
                ...data,
                forml_id: data?.form_id?.id ?? null,
                mat_id: data?.mat_id?.id ?? null,
        ...
        <Link
          onClick={() => {
            ...
            material?.forEach((elem) => {
              ...
              // elem.qty = elem.qty * Number(data.total);
            });
            let reject = data.reject;
            reject?.forEach((el) => {
...
export default DataDirectBatch;
