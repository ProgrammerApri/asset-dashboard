        ...
        <Col>
          <Card className="px-4 py-3 fs-13">
            <div className="flex justify-content-between align-items-center">
              ...
              <div className="">
                <label className="text-label">No. Formula</label>
                <br></br>
              ...
              <div className="">
                <label className="text-label">Nama Formula</label>
                <br></br>
                <span className="ml-0 fs-14">
                  <b>{show?.fname ?? "-"}</b>
                </span>
                ...
                <div className="row col-12">
                  ...
                  <div className="col-6 fs-12 ml-0">
                    <span className="ml-0 fs-12">
                      No. Formula : <b>{show?.fcode}</b>
                    </span>
                    <br></br>
                    <br></br>
                    <span className="ml-0">
                      Nama Formula : <b>{show?.fname ?? "-"}</b>
                    </span>
                  </div>
                  ...
                  <div className="col-6 fs-12 ml-0 text-right">
                    ...
                    <br></br>
                    <br></br> */}
                    <label className="text-label">Tanggal Formula : </label>
                    <span className="ml-1">
                      <b>{formatDate(show.date_created)}</b>
                    </span>
                  </div>
                </div>
              </Card>
