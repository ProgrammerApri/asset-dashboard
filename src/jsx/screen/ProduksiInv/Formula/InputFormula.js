...
const InputFormula = ({ onCancel, onSuccess }) => {
  ...
  const isValid = () => {
    ...
    valid =
      !errors.code && !errors.name && !errors.date && validProduct && validMtrl;
  ...
  const body = () => {
    ...
    return (
      <>
        ...
        <Row className="mb-4">
          <div className="col-3 fs-13 text-black">
            <PrimeInput
              label={"Kode Formula"}
              value={forml.fcode}
              onChange={(e) => {
          ...
          <div className="col-2 fs-13 text-black">
            <PrimeCalendar
              label={"Tanggal"}
          ...
          <div className="col-1 fs-13 text-black">
            <PrimeNumber
              label={"Versi"}
              value={forml.version}
              onChange={(e) => {
          ...
          <div className="col-5 fs-13 text-black">
          ...
          <div className="d-flex col-3 align-items-center mt-1">
          ...
          <div className="d-flex col-2 align-items-center mt-1">
            <b>
              <label className="mr-4 mt-1  fs-12 text-black">
                {"Auto Alokasi"}
              </label>
            </b>
            <InputSwitch
              className="ml-0"
              checked={forml && forml.auto_aloc}
              onChange={(e) => {
                let t_qty = 0;
                forml?.material?.forEach((elem) => {
                  t_qty += Number(elem.qty);
                });

                updateFM({
                  ...forml,
                  auto_aloc: e.target?.value,
                  product: forml?.product?.map((v) => ({
                    ...v,
