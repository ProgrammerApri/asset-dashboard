  ...
  const renderBody = () => {
    return (
      <>
        ...
        >
          <Column
            header={tr[localStorage.getItem("language")].kd_msn}
            style={{
              minWidth: "8rem",
            }}
            field={(e) => e.msn_code}
          ...
          />
          <Column
            header={tr[localStorage.getItem("language")].nm_msn}
            field={(e) => e.msn_name}
            style={{ minWidth: "8rem" }}
            body={load && <Skeleton />}
          />
      ...
      <>
        ...
        >
          <div className="row ml-0 mt-0">
            <div className="col-6">
              <PrimeInput
                label={tr[localStorage.getItem("language")].kd_msn}
                value={msn.msn_code}
                onChange={(e) => {
            ...
            <div className="col-6">
              <PrimeInput
                label={tr[localStorage.getItem("language")].nm_msn}
                value={msn.msn_name}
                onChange={(e) => {
